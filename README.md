...
## Goal
To make a model capable of displaying visually the idea expressed before, in a dynamic environment where many possibilities for city placement can be explored.
